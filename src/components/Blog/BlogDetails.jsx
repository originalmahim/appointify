          ...
          <div className="space-y-4 lg:border-[1px] border-gray-300 rounded-xl lg:mt-24 mt-16 p-4">
            ...
            <div className="flex justify-between items-center gap-2">
              ...
              <div className="flex justify-center items-center gap-2">
                ...
                <div className="flex justify-center items-center gap-2">
                  <FaComment className="text-blue-400"></FaComment>{" "}
                  <span>0</span>
                </div>
              </div>
            </div>
            <div
              className="blogDiv space-y-4 text-wrap"
            ...
            <form className="flex gap-2">
              <div className="flex-1">
                <textarea
                  ...
                  type="text"
                  className="input input-bordered border-[1px] border-gray-300 w-full"
                />
              </div>
              <div className="">
                <input
                  type="submit"
                  value="Comment"
                  className="btn btn-outline border-gray-300 text-xs"
                />
              </div>
            </form>
          </div>
